...
import com.finalboss.foroalura.domain.usuario.dto.CrearUsuarioDTO;
import com.finalboss.foroalura.domain.usuario.dto.DetallesUsuarioDTO;
import com.finalboss.foroalura.domain.usuario.repository.UsuarioRepository;
import com.finalboss.foroalura.domain.usuario.validaciones.create.ValidarCrearUsuario;
import com.finalboss.foroalura.domain.usuario.validaciones.update.ValidarActualizarUsuario;
...
public class UsuarioController {
    ...
    public ResponseEntity<DetallesUsuarioDTO> actualizarUsuario(@RequestBody ActualizarUsuarioDTO actualizarUsuarioDTO, @PathVariable String username){
